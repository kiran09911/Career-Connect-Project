...
// //   // Open chat for a specific candidate
...
// //           <DialogTitle>Chat with {selectedConversation?.name || "Candidate"}</DialogTitle>
// //           <DialogContent>
...
//   // Open chat for a specific candidate
//   const handleChatOpen = async (candidateId, candidateName) => {
//     console.log("handleChatOpen called with:", { candidateId, candidateName });

//     if (!candidateId || !user?.id) {
//       console.error("Missing candidateId or user.id");
//       setSnackbar({
//         open: true,
...
//                           color="secondary"
//                           startIcon={<ChatIcon />}
//                           onClick={() => handleChatOpen(app.candidate_id, app.candidate_name)}
//                         >
//                           Chat
//                         </Button>
//                         <Button
...
const RecruiterDashboard = () => {
  ...
  // Open chat for a specific candidate and job
  const handleChatOpen = async (candidateId, candidateName, jobId, jobTitle) => {
    ...
    if (!candidateId || !user?.id || !jobId) {
      console.error("Missing candidateId, user.id, or jobId:", { candidateId, userId: user?.id, jobId });
      setSnackbar({
        open: true,
        message: "Unable to start chat. Please try again.",
        severity: "error",
                    ...
                    >
                      ...
                      <CardActions sx={{ justifyContent: "space-between", p: 2 }}>
                        <Button
                          ...
                          color="secondary"
                          startIcon={<ChatIcon />}
                          onClick={() => handleChatOpen(app.candidate_id, app.candidate_name, app.job_id, app.job_title)}
                        >
                          Chat
                        </Button>
                        <Button
